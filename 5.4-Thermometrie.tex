...
$$T(U_{ind}) = \frac{753,24}{U_{ind}+151,71}$$ 
...
ermitteln. In unserem Fall liegt dieser bei $T_{\lambda}=2,17109K$, was einer
Abweichung von $0,0057K$ bzw.\ $0,26\%$ vom Literaturwert von $2,1768K$ entspricht.
